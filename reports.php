                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card tr" style=""><!-- wave guide 1 card-->
                                                                <div class="card-content"><!-- wg1 card content--->
                                                                    <div class="card-body mt-4">
                                                                        <center><a href="csv.php" class="" style=""><i class="fas fa-file tr" style="font-size:40px"></i></a><br><br></center>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card tr" style=""><!-- wave guide 1 card-->
                                                                <div class="card-content"><!-- wg1 card content--->
                                                                    <div class="card-body mt-4">
                                                                        <center><a href="graph_fix.php" class="text-dark" data-lity data-lity-target=""><i class="fas fa-chart-line fa-fw" style="font-size:40px"></i></a><br><br></center>
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card tr" style=""><!-- wave guide 1 card-->
                                                                <div class="card-content"><!-- wg1 card content--->
                                                                    <div class="card-body mt-4">
                                                                        <center><a href="" class="" style=""><i class="fas fa-file tr" style="font-size:40px"></i></a><br><br></center>
                                                                        <center><h6>Reports</h6></center>
                                                                    </div>
                                                                </div>
                                                            </div>
