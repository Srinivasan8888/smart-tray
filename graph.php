                        ...
                        <div class="card-content">
                            ...
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                    <span class="" style="color:white;"><a href="csv_download.php?sensor=sensor1" data-lity class="text-white"><i class="fas fa-file" style="font-size:25px"></i></a></span>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="" style="color:white;"><a href="graphfix.php?sensor=sensor1" data-lity class="text-white"><i class="fas fa-chart-line fa-fw" style="font-size:25px"></i></a></span>
                                            </div>
                                        </div>
                                </div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                    <span class="" style="color:white;"><a href="csv_download.php?sensor=sensor2" data-lity class="text-white"><i class="fas fa-file" style="font-size:25px"></i></a></span>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="" style="color:white;"><a href="graphfix.php?sensor=sensor2" data-lity class="text-white"><i class="fas fa-chart-line fa-fw" style="font-size:25px"></i></a></span>
                                            </div>
                                        </div>
                                </div>
                                <div class="ms-auto h1 pt-1 text-white">
                        ...
                        <div class="card-content">
                            ...
                            <div class="media d-flex">
                                <div class="media-body text-left">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                    <span class="" style="color:white;"><a href="csv_download.php?sensor=sensor3" data-lity class="text-white"><i class="fas fa-file" style="font-size:25px"></i></a></span>
                                            </div>
                                            <div class="col-md-4">
                                            <span class="" style="color:white;"><a href="graphfix.php?sensor=sensor3" data-lity class="text-white"><i class="fas fa-chart-line fa-fw" style="font-size:25px"></i></a></span>
                                            </div>
                                        </div>   
                                </div>
                                <div class="ms-auto h1 pt-1 text-white">
